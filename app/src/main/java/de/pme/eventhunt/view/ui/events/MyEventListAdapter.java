...
public class MyEventListAdapter  extends  RecyclerView.Adapter<MyEventListAdapter.MyEventListViewHolder>{
    ...
    private MyEventListAdapter.MyEventListViewHolder.OnNoteListener mOnNoteListener;

    public MyEventListAdapter(Context context, MyEventListAdapter.MyEventListViewHolder.OnNoteListener onNoteListener) {
    ...
    @NonNull
    @Override
    public MyEventListAdapter.MyEventListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = this.inflater.inflate(R.layout.list_item_event, parent, false);

        Log.i("OnCreateViewHolder", "Count " + ++MyEventListAdapter.counter);

        return new MyEventListAdapter.MyEventListViewHolder(itemView, mOnNoteListener);
    }

    @Override
    public void onBindViewHolder(@NonNull MyEventListAdapter.MyEventListViewHolder holder, int position) {
    ...
    static class MyEventListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        MyEventListAdapter.MyEventListViewHolder.OnNoteListener onNoteListener;


        public MyEventListViewHolder(@NonNull View itemView, MyEventListAdapter.MyEventListViewHolder.OnNoteListener onNoteListener) {
            super(itemView);
